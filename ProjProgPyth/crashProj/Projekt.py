...
print(nazwy) 
#zapisz odpowiedzi na pytania w plikach

#klasa z zapytaniami 

#1 ile było procentowo przypadków niepeoprawnej jazdy
...
#3 rodzaje wykroczeń które doprowadziły do wypadku i ich ilość
...
#6 w jakich godzinach dochodzi do największej liczby wypadków albo wykres liniowy z godzinammi ilością wypadków podczas nich.
